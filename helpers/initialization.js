...
if (config.PROJECT_SETTINGS.isLocal) {
  ...
  provider = new hre.ethers.WebSocketProvider(`wss://polygon-mumbai.g.alchemy.com/v2/${process.env.ALCHEMY_API_POLY}`)
}
...
const sFactory = new hre.ethers.Contract(config.QUICKSWAP.FACTORY_ADDRESS, IUniswapV2Factory.abi, provider)
const sRouter = new hre.ethers.Contract(config.QUICKSWAP.V2_ROUTER_02_ADDRESS, IUniswapV2Router02.abi, provider)
